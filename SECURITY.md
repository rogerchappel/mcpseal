...
Replace this section with the supported versions for `../mcpseal`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `../mcpseal` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ../mcpseal.
